...
* [ThreatLens](https://github.com/AbdaullahAG/Threat_Intel_Project) - Professional multi-source Threat Intelligence CLI tool designed for SOC and DFIR teams to investigate IPs, domains, hashes, and CVEs across 6 free APIs with automated log parsing and color-coded reporting.
